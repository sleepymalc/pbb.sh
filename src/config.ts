...
export const siteConfig: SiteConfig = {
  ...
  awards: [
    { date: 'Oct. 2025', title: 'Anthropic AI Safety Research Fellowship' },
    { date: 'Oct. 2021', title: 'Hong Kong, Macao and Taiwan Overseas Chinese Student Scholarship' },
    { date: 'Nov. 2020', title: 'Undergraduate Excellent Scholarship' },
    { date: 'Jun. 2020', title: 'Bao Gang Excellent Scholarship' },
    { date: 'Dec. 2019', title: 'Hong Kong, Macao and Taiwan Overseas Chinese Student Scholarship' },
  ],
  ...
  researchExperience: [
    {
      ...
      organization: 'SIG Deep Learning Team',
  ...
  service: {
    ...
    reviewing: {
      conferences: 'ICLR 2025/2026, NeurIPS 2025, ICML 2024/2026, IEEE BigData 2023',
      journals: 'TMLR',
